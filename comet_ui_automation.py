#!/usr/bin/env python3
"""
COMET UI AUTOMATION - PyAutoGUI Interface
========================================

Handles Comet's built-in UI elements (toolbar, buttons) that Selenium cannot reach.
Uses screen coordinates and keyboard shortcuts for reliable automation.

Functions:
- click_assistant_button_ui(): Clicks the Assistant button using calibrated coordinates
- type_in_address_bar_ui(): Types text in address bar using Ctrl+L shortcut
- find_assistant_button_coordinates(): Interactive coordinate finder utility
"""
